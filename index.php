...
<head>
  ...
  <script>
    ...
    if (window.location.hostname == "localhost") {
      document.getElementById("escenario").setAttribute("inspector", "url: http://localhost:3333/dist/aframe-inspector.js");
    } else {
      document.getElementById("escenario").setAttribute("inspector", "url: https://cdn.jsdelivr.net/gh/aframevr/aframe-inspector@master/dist/aframe-inspector.min.js");
    }
    */
    //document.querySelector('a-scene').setAttribute('inspector','url: http://localhost:3333/dist/aframe-inspector.js')
...
<body>
  <a-scene id="escenario" embedded arjs="debugUIEnabled: false;">
    ...
    <a-marker preset="hiro" position="" rotation="" material="" arjs-hit-testing="" visible="false">
      ...
      <a-entity geometry="primitive: circle" rotation="-90 0 0" material="src: objetos/arena.jpg" position="0.034 0.026 -0.082" scale="1.292 1.286 1.994"></a-entity>
      ...
      <a-entity layout="type: box; columns: 1; margin: 5" position="0 0.137 -0.151">
        <a-entity spe-particles="texture: objetos/fog.png; velocity: .2 1 0; velocity-spread: .2 0 .2; particle-count: 50; max-age: 4; size: 3,8; opacity: 0,1,0; color: #aaa,#222">
        </a-entity>
      </a-entity>
